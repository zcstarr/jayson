 ...
 */
ClientBrowser.prototype.request = promisify(function(method, params, id, callback) {
  const self = this;
  let request = null;
 ...
 * @private
 */
ClientBrowser.prototype._parseResponse = promisify(function(err, responseText, callback) {
  if(err) {
    callback(err);
    return;
  }
